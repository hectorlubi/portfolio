...
// keyboardBuilds.js
// ========================================
// Data for keyboard build gallery
// Each keyboard includes specifications, images, and sound tests
// ========================================
...
export const keyboardBuilds = [
  ...
  },
  {
    id: 3,
    name: 'Neo Ergo',
    switch: 'Gazzew Boba U4',
    keycaps: 'Osume Kanagawa',
    plate: 'PP',
    layout: 'Alice (65%)',
  ...
  },
  {
    id: 4,
    name: 'ai03 Vega',
    switch: 'Cherry MX Purple',
    keycaps: 'KBDfans Klein Blue',
    plate: 'POM',
    layout: '65%',
  ...
  {
    id: 5,
    name: 'GEONWORKS F1-8x v2',
    switch: 'Gateron Root Beer',
    keycaps: 'GMK Hineybeige',
